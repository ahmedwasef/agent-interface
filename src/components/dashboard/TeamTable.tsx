      ...
      <table className="w-full text-xs">
        <thead>
          <tr className="border-b border-slate-700/50">
            <th className="text-left px-5 py-3 text-slate-400 font-medium">{t('team.rank')}</th>
            <th className="text-left px-5 py-3 text-slate-400 font-medium">{t('team.agent')}</th>
            <th className="text-center px-3 py-3 text-slate-400 font-medium">{t('team.total')}</th>
            <th className="text-center px-3 py-3 text-emerald-400 font-medium">{t('team.done')}</th>
            <th className="text-center px-3 py-3 text-blue-400 font-medium">{t('team.active')}</th>
            <th className="text-center px-3 py-3 text-amber-400 font-medium">{t('team.hold')}</th>
            <th className="text-center px-3 py-3 text-gray-400 font-medium">{t('team.pending')}</th>
            <th className="text-left px-5 py-3 text-slate-400 font-medium">{t('team.rate')}</th>
        ...
        <tbody>
          {sorted.map((s, i) => {
            ...
            return (
              <tr key={s.agentId} className="border-b border-slate-700/30 hover:bg-slate-700/20 transition-colors">
